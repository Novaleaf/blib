...
export function initialize(/**
	...
	_initializeCompletePromise = new Promise<string>(( resolve, reject ) => {
		jquery.getScript( `https://maps.googleapis.com/maps/api/js?key=${ mapsApiKey }&libraries=places`, ( script: string, textStatus: string, jqXHR: JQueryXHR ) => {
 ...
 * @param request
 */
export function getAutocompletePlacePredictions( requestOptions: google.maps.places.IPlacePredictionRequestOptions, retryAttempt = 0 ): Promise<google.maps.places.IPredictionResult[]> {
	...
	return new Promise<google.maps.places.IPredictionResult[]>(( resolve, reject ) => {
		...
		return _initializeCompletePromise.then(() => {
			...
			let _callback = function ( predictions: google.maps.places.IPredictionResult[], status: string ) {
 ...
 * @param retryAttempt
 */
export function getPlaceDetails( request: { placeId: string }, retryAttempt = 0 ): Promise<google.maps.places.IPlace | null> {
	...
	return new Promise<google.maps.places.IPlace|null>(( resolve, reject ) => {
		...
		return _initializeCompletePromise.then(() => {
			...
			let _callback = function ( place: google.maps.places.IPlace, status: string ) {
